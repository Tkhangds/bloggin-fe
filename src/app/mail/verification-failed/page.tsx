...
import { VerificationProblemsEnum } from "@/enums/mail-verification-problem.enum";
...
export default function VerificationFailedPage({
  ...
  const verificationProblem = searchParams.problem || "UNEXPECTED_ERROR";
  const verificationMessage =
    VerificationProblemsEnum[
      verificationProblem as keyof typeof VerificationProblemsEnum
    ] ||
    "An unexpected error occurred during email verification. Please try again later or contact support for assistance.";
    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* Heading */}
          <h1 className="mb-6 text-5xl font-semibold tracking-tight text-foreground text-red-500 delay-100 duration-700 animate-in fade-in md:text-6xl">
            Oops...
          </h1>
